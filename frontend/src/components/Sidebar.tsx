...
import {
  LayoutDashboard, FileText, Car, Users, TrendingUp,
  Calendar, CalendarDays, Settings, LogOut
} from 'lucide-react'
...
export default function Sidebar({ onClose }: Props) {
  ...
  return (
    <aside className="w-52 h-full bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 flex flex-col shadow-xl">
        ...
        {links.map(({ to, label, icon: Icon }) => (
          <NavLink
            ...
            className={({ isActive }) =>
              ...
              (isActive
                ? 'border-brand text-brand bg-orange-50 dark:bg-gray-800'
