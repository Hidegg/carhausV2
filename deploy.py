...
with app.app_context():
    ...
    fresh = 'locatie' not in existing_tables
    ...
    if fresh:
        ...
        # Only needed for existing DBs where Alembic was stamped without
        # running migrations. Uses PostgreSQL syntax (IF NOT EXISTS).
        with db.engine.connect() as conn:
            stmts = [
                ...
                "ALTER TABLE spalatori ADD COLUMN IF NOT EXISTS activ BOOLEAN NOT NULL DEFAULT TRUE",
                # clienti
